  ...
  return (
    <Html lang="ja-JP" prefix="og:http://ogp.me/ns#">
      <Head>
        ...
        <meta
          property="og:title"
          content="nutfes-Bingo / 技大祭ビンゴアプリ | 技大祭実行委員会"
        />
        <meta property="og:url" content="https://bingo.nutfes.net/" />
        <meta
          name="description"
          content="技大祭のフィナーレを飾るビンゴ大会専用のアプリです。"
        />
        <meta
          property="og:description"
          content="長岡技術科学大学‐技大祭のフィナーレを飾るビンゴ大会専用のアプリです。"
        />
        <meta name="twitter:card" content="summary_large_image" />
        <meta
          property="og:image"
          content="https://bingo.nutfes.net/opengraph-image.png"
        />
