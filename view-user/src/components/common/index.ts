...
export {default as TestBingoList} from "./TestBingoList"
export {default as TestBingoCreate} from "./TestBingoCreate"
export {default as TestBingoDelete} from "./TestBingoDelete"
