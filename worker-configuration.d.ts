/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 9c3ddaa871308b0d3411a9658daeac6a)
// Runtime types generated with workerd@1.20260630.1 2026-07-07 nodejs_compat
interface __BaseEnv_Env {
  PRIZE_IMAGES: R2Bucket;
  GAME_BACKUPS: R2Bucket;
  ASSETS: Fetcher;
  ACCESS_TEAM_DOMAIN: string;
  ACCESS_AUD: string;
  ADMIN_EMAILS: string;
  SCREEN_ACCESS_AUD: string;
  RELEASE_SHA: string;
  SCREEN_EMAILS: string;
  MEDIA_ORIGIN: string;
  LOCAL_ADMIN_BYPASS: string;
  LOCAL_SCREEN_BYPASS: string;
  LOCAL_TURNSTILE_TEST_MODE: string;
  STAMP_DAILY_LIMIT: string;
  TURNSTILE_HOSTNAME: string;
  TURNSTILE_SECRET_KEY: string;
  GAME_DIRECTORY: DurableObjectNamespace<import("./worker/index").GameDirectory>;
  GAME_STATE: DurableObjectNamespace<import("./worker/index").GameState>;
  REACTION_HUB: DurableObjectNamespace<import("./worker/index").ReactionHub>;
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./worker/index");
    durableNamespaces: "GameDirectory" | "GameState" | "ReactionHub";
  }
