...
import BingoResult from "@/components/admin/common/BingoResult/BingoResult";
import Header from "@/components/admin/common/Header/Header";
import JudgementModal from "@/components/admin/common/JudgementModal/JudgementModal";
  ...
  return (
    <AdminPageShell>
      ...
      <AdminPageContent className="mt-6 grid grid-cols-1 gap-5 lg:grid-cols-2">
        ...
        <AdminPanel
          title="抽選した番号を削除"
          description="入力または候補選択で抽選済み番号を取り消します。"
          contentClassName="space-y-3"
        >
          <Form
            className="gap-3"
