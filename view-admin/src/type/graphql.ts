...
export type GetLatestEventSurveyQueryVariables = Exact<{
  [key: string]: never;
}>;

export type GetLatestEventSurveyQuery = {
  __typename?: "query_root";
  events: Array<{
    __typename?: "Events";
    id: any;
...
export type CreateEventSurveyMutationVariables = Exact<{
  surveyUrl: Scalars["String"]["input"];
  isSurveyActive: Scalars["Boolean"]["input"];
}>;

export type CreateEventSurveyMutation = {
  __typename?: "mutation_root";
  insertEventsOne?: {
    __typename?: "Events";
    id: any;
...
export const GetLatestEventSurveyDocument = gql`
  query GetLatestEventSurvey {
...
`;
export type GetLatestEventSurveyQueryResult = Apollo.QueryResult<
  GetLatestEventSurveyQuery,
  GetLatestEventSurveyQueryVariables
>;
export const CreateEventSurveyDocument = gql`
  mutation CreateEventSurvey($surveyUrl: String!, $isSurveyActive: Boolean!) {
    insertEventsOne(
      object: { surveyUrl: $surveyUrl, isSurveyActive: $isSurveyActive }
    ) {
      id
      surveyUrl
      isSurveyActive
...
`;
export type CreateEventSurveyMutationFn = Apollo.MutationFunction<
  CreateEventSurveyMutation,
  CreateEventSurveyMutationVariables
>;
export type CreateEventSurveyMutationResult =
  Apollo.MutationResult<CreateEventSurveyMutation>;
export type CreateEventSurveyMutationOptions = Apollo.BaseMutationOptions<
  CreateEventSurveyMutation,
  CreateEventSurveyMutationVariables
>;
